                                ...
                                <div class="col-xl-9">
                                    <div class="mt-4 mt-xl-3">
                                        <div class="row mb-1">
                                            ...
                                            <div class="col-sm-4">
                                                <a href="{{ route('products.index') }}"><i class="bx bx-arrow-back"></i> Back to products</a>
                                            </div>
                                        </div>

                                        <div class="row">
                                            <div class="col-sm-4">
                                                <h6 class="mt-1 mb-2">Article Code: <strong>{{ $product->article_code }}</strong></h6>
                                            </div>
                                            <div class="col-sm-4">
                                                <div>
                                    ...
                                    <table class="table mb-0 table-bordered">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                @foreach ($product->sizes as $size)
                                                    <td class="p-1"><strong>{{ $size->quantity($color->id) }}</strong> / {{ $size->totalQuantity($color->id) }}</td>
                                                @endforeach
                                            </tr>
                                            @endforeach
