...
<div id="product-fields-container">
    <div class="product-field-group mb-3 border p-3" data-product-index="0">
        <div class="row">
            <div class="col-sm-6 col-md-2 mb-3">
                <x-form-input name="products[0][product_code]" label="Product Code"
                    placeholder="Enter Product Code" required />
            </div>
            <div class="col-sm-6 col-md-2 mb-3">
                <x-form-input name="products[0][supplier_color_code]" label="Supplier Color Code"
            ...
            <div class="col-sm-6 col-md-3 mt-4">
                <button type="button" class="btn btn-primary add-product-variant"><i class="fas fa-plus"></i>
                    Variant</button>
