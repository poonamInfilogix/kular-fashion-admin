<form action="{{ route('payment-methods.update', 'klarna') }}" method="POST">
    ...
    <div class="row">
        <div class="col-md-6 mb-2">
            <x-form-input name="klarna_merchant_id" value="{{ setting('klarna_merchant_id') }}"
                label="Merchant ID" placeholder="Merchant ID" required="true" />
        </div>

        <div class="col-md-6 mb-2">
            <x-form-input name="klarna_api_username" value="{{ decryptData(setting('klarna_api_username')) }}"
