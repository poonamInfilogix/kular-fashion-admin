<div class="row mb-2">
    <div class="col-sm-6 col-md-3">
        <div class="mb-3">
            <x-form-input name="name" value="{{ $brand->name ?? '' }}" label="Brand Name" placeholder="Enter Brand Name"
                required="true" />
        </div>
    </div>
    ...
    <div class="col-sm-6 col-md-2">
        <div class="mb-3">
            ...
            <select name="status" id="brand-status" class="form-control">
                <option value="Active" {{ isset($brand) && $brand->status === 'Active' ? 'selected' : '' }}>Active
                </option>
