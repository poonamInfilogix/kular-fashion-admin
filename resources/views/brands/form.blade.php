<div class="row mb-2">
    <div class="col-sm-6 col-md-3">
        <div class="mb-3">
            <x-form-input name="name" value="{{ $brand->name ?? '' }}" label="Brand Name" placeholder="Enter Brand Name"  required="true"/>
        </div>
    </div>
    ...
    <div class="col-sm-6 col-md-3">
        <div class="mb-3 position-relative">
            ...
            <div class="input-group">
                <input type="text" class="form-control" name="margin" value="{{ $brand->margin ?? '' }}" label="Margin" placeholder="Enter Margin" min="0" max="100"/>
