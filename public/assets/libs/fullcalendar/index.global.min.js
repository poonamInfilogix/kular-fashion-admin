...
var FullCalendar = (function (e) {
    ...
    class cs {
        ...
        splitEntry(e, t, n) {
            ...
            return (
                ...
                r ? (n.push({ index: e.index, thickness: e.thickness, span: fs(o, s) }, ...i), r) : (n.push(e), 0)
            );
        }
        insertEntryAt(e, t) {
    ...
    class al extends Gn {
        render() {
            ...
            return p(so, Object.assign({}, e, { elTag: "a", elClasses: ["fc-daygrid-event", "fc-daygrid-dot-event"], elAttrs: bi(e.seg, t), defaultGenerator: ll, timeText: i, isResizing: !1, isDateSelecting: !1 }));
        }
    }
    function ll(e) {
        return p(
                    ...
                    return p(
                        ...
                        t.map((t) => {
                            ...
                            return p(
                                ...
                                sl(t)
                                    ? p(al, Object.assign({ seg: t, isDragging: !1, isSelected: r === e.eventSelection, defaultDisplayEventEnd: !1 }, mi(t, e.todayRange)))
                                    : p(ol, Object.assign({ seg: t, isDragging: !1, isResizing: !1, isDateSelecting: !1, isSelected: r === e.eventSelection, defaultDisplayEventEnd: !1 }, mi(t, e.todayRange)))
                            );
                        })
                    );
                },
            ...
            return p(
                ...
                (s, a) =>
                    p(
                        ...
                        t.showWeekNumber && p(vo, { elTag: "a", elClasses: ["fc-daygrid-week-number"], elAttrs: qi(e, o, "week"), date: o, defaultFormat: ul }),
    ...
    function ml(e, t, n, r, i, s, o) {
        ...
        let d = a.addSegs(l),
            ...
            { singleColPlacements: h, multiColPlacements: f, leftoverMargins: g } = (function (e, t, n) {
                ...
                for (let e = 0; e < n.length; e += 1) {
                    ...
                    for (let r of a) {
                        let i = t[r.index];
                        l.push({ seg: vl(i, e, e + 1, n), isVisible: !0, isAbsolute: !1, absoluteTop: r.levelCoord, marginTop: r.levelCoord - c }), (c = r.levelCoord + r.thickness);
                    }
                    let u = [];
                    (c = 0), (d = 0);
                    for (let r of a) {
                        ...
                        (d += r.levelCoord - c),
                            ...
                            s
                                ? ((d += r.thickness), o && u.push({ seg: vl(i, r.span.start, r.span.end, n), isVisible: !0, isAbsolute: !0, absoluteTop: r.levelCoord, marginTop: 0 }))
                                : o && (u.push({ seg: vl(i, r.span.start, r.span.end, n), isVisible: !0, isAbsolute: !1, absoluteTop: r.levelCoord, marginTop: d }), (d = 0));
                    }
        ...
        for (let e of c) {
            ...
            for (let t = e.firstCol; t <= e.lastCol; t += 1) h[t].push({ seg: vl(e, t, t + 1, o), isVisible: !1, isAbsolute: !1, absoluteTop: 0, marginTop: 0 });
        }
        for (let e = 0; e < o.length; e += 1) p.push(0);
        for (let t of d) {
            let n = e[t.index],
                r = t.span;
            f[r.start].push({ seg: vl(n, r.start, r.end, o), isVisible: !1, isAbsolute: !0, absoluteTop: 0, marginTop: 0 });
            for (let e = r.start; e < r.end; e += 1) (p[e] += 1), h[e].push({ seg: vl(n, e, e + 1, o), isVisible: !1, isAbsolute: !1, absoluteTop: 0, marginTop: 0 });
        }
                    ...
                    m && (a.isRtl ? ((y = 0), (v = c.lefts[t.lastCol] - c.lefts[t.firstCol])) : ((v = 0), (y = c.rights[t.firstCol] - c.rights[t.lastCol]))),
                        h.push(
                            p(
                                ...
                                sl(t)
                                    ? p(al, Object.assign({ seg: t, isDragging: i, isSelected: f === l, defaultDisplayEventEnd: d }, mi(t, n)))
                                    : p(ol, Object.assign({ seg: t, isDragging: i, isResizing: s, isDateSelecting: o, isSelected: f === l, defaultDisplayEventEnd: d }, mi(t, n)))
                            )
                        );
                }
            return h;
    ...
    class Cl extends gr {
        buildRenderRange(e, t, n) {
            let r = super.buildRenderRange(e, t, n),
                { props: i } = this;
            return Rl({ currentRange: r, snapToWeek: /^(year|month)$/.test(t), fixedWeekCount: i.fixedWeekCount, dateEnv: i.dateEnv });
        }
    }
    function Rl(e) {
        let t,
